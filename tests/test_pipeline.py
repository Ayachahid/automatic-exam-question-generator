...
class TestPipelineInitialization:
    ...
    def test_pipeline_init(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_init_with_custom_config_path(
        self, mock_load_config, mock_provider_factory
    ):
        """Test initialization with custom config path."""
        QuestionGenerationPipeline(config_path="custom/config.yaml")
        mock_load_config.assert_called_with("custom/config.yaml")

    def test_pipeline_init_with_file_path(
        self, mock_load_config, mock_provider_factory
    ):
    ...
    def test_pipeline_components_initialized(
        self,
        mock_load_config,
...
class TestPipelineRunText:
    ...
    def test_pipeline_run_text_single_chunk(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_run_text_multiple_chunks(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_run_text_cleans_input(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_run_text_no_questions_requested(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_run_text_more_requested_than_chunks(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_run_text_early_stop(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
...
class TestPipelineRunFile:
    ...
    def test_pipeline_run_file_uses_constructor_path(
        self,
        mock_load_config,
        mock_provider_factory,
        mock_chunker_factory,
        ...
        mock_loader_factory.return_value.get_loader.assert_called_with(
            "constructor_file.pdf"
        )
...
class TestPipelineConfiguration:
    ...
    def test_pipeline_uses_config_question_type(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_override_question_type(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_override_difficulty(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_override_num_questions(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
...
class TestPipelineEdgeCases:
    ...
    def test_pipeline_empty_parser_result(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_malformed_json_from_llm(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_partial_questions_generated(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
    ...
    def test_pipeline_truncates_to_requested_num(
        self, mock_load_config, mock_provider_factory, mock_chunker_factory
    ):
